...
def camera_rotation(type, path, img_path):
    ...
    # for i in range(4):
    rotate_para = [[0, 0], [90 * interval, 0], [90 * interval, 0], [90 * interval, 0], [0, 90 * interval],
                   [0, 180 * interval]]
    for i in range(6):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default = 'D:\PCQA\data\wpc\wpc') #path to the file that contain .ply models
    parser.add_argument('--img_path', type=str, default = 'D:\PCQA\data\wpc\img_6') # path to the generated 2D input
