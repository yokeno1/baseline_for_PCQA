...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default = 'D:\PCQA\data\sjtu-database\data') #path to the file that contain .ply models
    parser.add_argument('--out_path', type=str, default = 'D:\PCQA\data\sjtu-database\patch/') # path to the output patches
